    ...
    public void runOpMode() {
        ...
        switch (POSITION_GOLD) {
            case "LEFT":
                ...
                encoderDrive(0.75, -6000, -6000, -6000, -6000, 0, 0, 4.0);
                ...
                encoderDrive(10, 4000, 4000, 4000, 4000, 0, 0, 3.0);
                robot.gyroTurn(0.5, 30);
                encoderDrive(1, 4000, 4000, 4000, 4000, 0, 0, 6.0);
                encoderDrive(0.75, 0, 0, 0, 0, 500, 0, 3.0);
                robot.gyroTurn(0.5, 45);
                runtime.reset();
            ...
            case "CENTER":
                ...
                robot.gyroTurn(0.5, -8);
                encoderDrive(0.75, -5000, -5000, -5000, -5000, 0, 0, 5.0);
                robot.yeet.setPosition(1.0);
                sleep(800);
                robot.gyroTurn(0.5, 45);
                encoderDrive(10, 4200, 4200, 4200, 4200, 0, 0, 3.0);
                robot.gyroTurn(0.5, 3);
                encoderDrive(10, 4500, 4500, 4500, 4500, 0, 0, 3.0);
                robot.gyroTurn(0.5, 100);
                encoderDrive(1, 1500, 1500, 1500, 1500, 0, 0, 3.0);
                encoderDrive(0.75, 0, 0, 0, 0, 500, 0, 3.0);
                break;
            default:  //this is exception handling. it includes the "RIGHT" case and all other situations. RIGHT is the most reliable.


                encoderDrive(0.5, -550, 550, -550, 550, 0, 0, 1.0);
                encoderDrive(0.75, -600, -600, -600, -600, 0, 0, 1.0);
                robot.gyroTurn(0.5, -40);
                encoderDrive(0.75, -4200, -4200, -4200, -4200, 0, 0, 3.0);
                robot.gyroTurn(0.5, 45);
                while (robot.range.getDistance(DistanceUnit.INCH) > 14.0) {
                    robot.setPower(-0.5);
                }
                ...
                sleep(800);
                robot.gyroTurn(0.5, 45);
                encoderDrive(1, 4100, 4100, 4100, 4100, 0, 0, 5.0);
                robot.gyroTurn(0.5, 3);
                encoderDrive(1, 5400, 5400, 5400, 5400, 0, 0, 3.0);
                robot.gyroTurn(0.5, 85);
