    ...
    public void runOpMode() {
        ...
        switch (POSITION_GOLD) {
            case "LEFT":
                ...
                robot.setPower(0);
                sleep(300);
                robot.gyroTurn(0.75, 10);
                encoderDrive(1.0, 6000, 6000, 6000, 6000, 0, 0, 4.0);
                robot.gyroTurn(0.75, 60);
                encoderDrive(1.0, -5500, -5500, -5500, -5500, 0, 0, 3.0);
                robot.yeet.setPosition(1.0);
                sleep(800);
                robot.gyroTurn(0.75, 130);
                encoderDrive(1.0, 7000, 7000, 7000, 7000, 0, 0, 5.0);
            ...
            case "CENTER":
                ...
                encoderDrive(0.5, 2200, 2200, 2200, 2200, 0, 0, 3.0);
                robot.gyroTurn(0.5, 45);
                while (robot.range.getDistance(DistanceUnit.INCH) > 6.0) {
                    robot.setPower(-0.5);
                }
                ...
                robot.gyroTurn(0.75, 75);
                encoderDrive(1.0, -4000, -4000, -4000, -4000, 0, 0, 3.0);
                robot.yeet.setPosition(1.0);
                sleep(800);
                robot.gyroTurn(0.75, 134);
                encoderDrive(1.0, 7000, 7000, 7000, 7000, 0, 0, 5.0);
            ...
            default:  //this is exception handling. it includes the "RIGHT" case and all other situations. RIGHT is the most reliable.
                ...
                sleep(600);
                robot.gyroTurn(0.75, 10);
                encoderDrive(1.0, 3200, 3200, 3200, 3200, 0, 0, 3.0);
                robot.gyroTurn(0.75, 90);
                encoderDrive(1.0, -4000, -4000, -4000, -4000, 0, 0, 3.0);
                robot.yeet.setPosition(1.0);
                sleep(800);
                robot.gyroTurn(0.75, 120);
                encoderDrive(1.0, 7000, 7000, 7000, 7000, 0, 0, 5.0);
